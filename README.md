# Python
 ...
 8. [Usando o comando `break` e `continue`](https://github.com/marcospontoexe/Python/tree/main/exerc%C3%ADcios_curso%20em%20v%C3%ADdeo/08-break): Veja como usar o comando `break` para interromper blocos de repetições e condicionais 
