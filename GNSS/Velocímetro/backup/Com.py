...
janela.geometry("300x200+200+100")  # define o posicionamento e tamanho da tela (largura X altura + distância à esqueda + dist topo) em pixel
...
lbCom = Label(janela, text="Portas COM:", background='#7d8aa1', font=('Comic Sans MS', 8))
lbCom.place(x=14, y=15)
lbFuso = Label(janela, text="Fuso horário:", background='#7d8aa1', font=('Comic Sans MS', 8))
...
btFechar.config(background='#7d8aa1', foreground='#dde', borderwidth=2, text='Concluir', font=('Comic Sans MS', 20, 'bold'))
...
fusoInt = int(fuso.get()[-2:])  # recebe apenas os dois u´ltimos índices da string convertido para int
